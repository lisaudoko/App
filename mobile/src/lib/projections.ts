...
/**
 * Linear-regresses an athlete's last 6 logged marks and projects forward to
 * `targetWeekNumber` (e.g. a competition week). Returns null if there isn't
 * enough logged data (fewer than 2 marks) to fit a line.
 */
